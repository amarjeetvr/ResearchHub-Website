  ...
  try {
    ...
    if (!user || user.role !== "freelancer") {
      return res.status(403).json({
        message: "Only Researchers can view their proposals",
        success: false,
      });
    }
...
export const getMyActiveProjects = async (req, res) => {
  try {
    ...
    if (!user || user.role !== "freelancer") {
      return res.status(403).json({
        message: "Only Researchers can view their active projects",
        success: false,
      });
    }
...
export const getMyCompletedProjects = async (req, res) => {
  try {
    ...
    if (!user || user.role !== "freelancer") {
      return res.status(403).json({
        message: "Only Researchers can view their completed projects",
        success: false,
      });
    }
...
export const getResearcherstats = async (req, res) => {
  try {
    const freelancerId = req.id;
    ...
    if (!user || user.role !== "freelancer") {
      return res.status(403).json({
        message: "Only Researchers can view their statistics",
        success: false,
      });
    }
...
export const updateProgress = async (req, res) => {
  try {
    ...
    if (!user || user.role !== "freelancer") {
      return res.status(403).json({
        message: "Only Researchers can update progress",
        success: false,
      });
    }
