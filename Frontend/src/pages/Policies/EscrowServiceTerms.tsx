          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ResearchHub's Escrow Service provides a secure payment mechanism that protects both clients and Researchers. 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                In case of disputes between clients and Researchers:
              </p>
