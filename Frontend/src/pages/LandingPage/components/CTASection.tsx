...
export default function CTASection({ onNavigate }: CTASectionProps) {
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-[#2D6CDF] to-[#1F1F1F]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
          ...
          <button
            ...
            className="border-2 border-white text-white px-8 sm:px-10 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg hover:bg-white hover:text-[#2D6CDF] transition-all"
          >
