...
interface SearchResultsSectionProps {
  filteredResearchers: Freelancer[];
      ...
      <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
        <div className="lg:col-span-2">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">
                Found {filteredResearchers.length} expert{filteredResearchers.length !== 1 ? 's' : ''} matching your criteria
              </p>
            </div>
            <button
              onClick={(e) => {
          ...
          <div className="grid gap-4 sm:gap-6">
            {filteredResearchers.map((freelancer) => (
              ...
              <div>
                <div className="flex items-start gap-2 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Restrict who can see your project and send you proposals. Invite only specific Researchers to view your project.</p>
                  </div>
                </div>
              </div>
