...
export default function AboutPage({ onNavigate }: AboutPageProps) {
  return (
    <div className="bg-white min-h-screen">
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-blue-600 to-blue-700 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">200+ Research Domains</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Verified Researchers</h3>
              <p className="text-lg text-slate-700 leading-relaxed">
      ...
      <section className="py-16 px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-12 text-white text-center shadow-2xl">
